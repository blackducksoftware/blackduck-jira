...
public class JiraIssueHandler {
    ...
    public JiraIssueHandler(final JiraIssueServiceWrapper issueServiceWrapper, final JiraSettingsService jiraSettingsService, final HubIssueTrackerHandler hubIssueTrackerHandler,
