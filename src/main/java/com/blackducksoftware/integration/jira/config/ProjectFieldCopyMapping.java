...
public class ProjectFieldCopyMapping {
    ...
    private final String jiraFieldName;

    public ProjectFieldCopyMapping(String jiraProjectName, String hubProjectName, PluginField pluginField, String jiraFieldName) {
        super();
