...
public abstract class ConfigActions {
    ...
    public ConfigActions(final PluginSettingsFactory pluginSettingsFactory) {
        this.pluginSettingsWrapper = new PluginSettingsWrapper(pluginSettingsFactory.createGlobalSettings());
    }

    public PluginSettingsWrapper getPluginSettingsWrapper() {
        return pluginSettingsWrapper;
    }
