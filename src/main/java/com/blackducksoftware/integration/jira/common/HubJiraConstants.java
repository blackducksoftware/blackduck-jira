...
public class HubJiraConstants {
	...
	public final static String HUB_WORKFLOW_TRANSITION_REMOVE_OR_OVERRIDE = "remove/Override";
	public final static String HUB_WORKFLOW_TRANSITION_READD_OR_OVERRIDE_REMOVED = "reAdded/overrideRemoved";
}
