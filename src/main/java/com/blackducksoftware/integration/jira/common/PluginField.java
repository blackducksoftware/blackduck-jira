...
public enum PluginField {
    ...
    HUB_CUSTOM_FIELD_COMPONENT_USAGE("HUB_CUSTOM_FIELD_COMPONENT_USAGE", HubJiraConstants.HUB_CUSTOM_FIELD_COMPONENT_USAGE, HubJiraConstants.HUB_CUSTOM_FIELD_COMPONENT_USAGE_DISPLAYNAMEPROPERTY),
    HUB_CUSTOM_FIELD_COMPONENT_ORIGIN("HUB_CUSTOM_FIELD_COMPONENT_ORIGIN", HubJiraConstants.HUB_CUSTOM_FIELD_COMPONENT_ORIGIN, HubJiraConstants.HUB_CUSTOM_FIELD_COMPONENT_ORIGIN_DISPLAYNAMEPROPERTY),
    HUB_CUSTOM_FIELD_COMPONENT_ORIGIN_ID("HUB_CUSTOM_FIELD_COMPONENT_ORIGIN_ID", HubJiraConstants.HUB_CUSTOM_FIELD_COMPONENT_ORIGIN_ID, HubJiraConstants.HUB_CUSTOM_FIELD_COMPONENT_ORIGIN_ID_DISPLAYNAMEPROPERTY),
    HUB_CUSTOM_FIELD_PROJECT_VERSION_NICKNAME("HUB_CUSTOM_FIELD_PROJECT_VERSION_NICKNAME", HubJiraConstants.HUB_CUSTOM_FIELD_PROJECT_VERSION_NICKNAME, HubJiraConstants.HUB_CUSTOM_FIELD_PROJECT_VERSION_NICKNAME_DISPLAYNAMEPROPERTY);
