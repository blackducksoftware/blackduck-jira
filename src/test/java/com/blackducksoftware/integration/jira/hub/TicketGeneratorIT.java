...
// import
// com.blackducksoftware.integration.jira.hub.model.notification.PolicyOverrideNotificationItem;
// import
// com.blackducksoftware.integration.jira.hub.model.notification.RuleViolationNotificationItem;
// import
// com.blackducksoftware.integration.jira.hub.model.notification.VulnerabilityNotificationItem;
...
//
/// **
// * DELETE THIS WHOLE CLASS; I'm just using them temporarily during
// development.
// *
// * @author sbillings
// *
...
//
// @Test
// public void testGetRule() throws URISyntaxException, BDRestException,
// HubNotificationServiceException {
// final RestConnection restConnection = new
// RestConnection("http://eng-hub-valid03.dc1.lan/");
// restConnection.setCookies("sysadmin", "blackduck");
// final HubIntRestService hub = new HubIntRestService(restConnection);
//
// final TypeToken<NotificationItem> typeToken = new
// TypeToken<NotificationItem>() {
// };
// final Map<String, Class<? extends NotificationItem>> typeToSubclassMap = new
// HashMap<>();
...
//
// final HubItemsService<NotificationItem> hubItemsService = new
// HubItemsService<>(restConnection,
// NotificationItem.class, typeToken, typeToSubclassMap);
//
// final HubNotificationService svc = new HubNotificationService(restConnection,
// hub, hubItemsService);
//
...
// HubNotificationServiceException, BDRestException,
...
// NotificationItem.class, typeToken, typeToSubclassMap);
//
// final JiraService jiraService = new JiraService(null,
// "http://bds00829:2990/jira", "Bug"); // TODO
// // this
// // won't
// // work
// final TicketGenerator ticketGenerator = new TicketGenerator(restConnection,
// hub, hubItemsService, jiraService);
//
// final SimpleDateFormat dateFormatter = new
// SimpleDateFormat(RestConnection.JSON_DATE_FORMAT);
//
...
//
// final NotificationDateRange notificationDateRange = new
