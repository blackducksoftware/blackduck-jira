...
public class PolicyOverrideNotificationConverterTest {
    ...
    private List<HubEvent> generateEvents(final List<PolicyRule> rules, final boolean includeProjectMappings,
        ...
        ProjectFieldCopyMapping projectFieldCopyMapping = new ProjectFieldCopyMapping("Test", "Test", PluginField.HUB_CUSTOM_FIELD_COMPONENT.getId(),
                PluginField.HUB_CUSTOM_FIELD_COMPONENT.getName(), "EnvironmentId",
                "Environment");
