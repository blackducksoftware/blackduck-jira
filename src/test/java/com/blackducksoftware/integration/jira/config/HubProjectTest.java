...
public class HubProjectTest {
    ...
    public void testHubProject() {
        ...
        builder.append(", projectIssuesUrl=");
        builder.append(item1.getProjectIssueTrackerUrl());
        builder.append("]");
